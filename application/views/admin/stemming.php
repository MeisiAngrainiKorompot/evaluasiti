<div class="container-fluid">
    ...
    <h1 class="h3 mb-0 text-grey-800"><?php echo $title ?></h1>
        <div class="ml-auto">
            <a href="<?php echo base_url('admin/evaluasi/stemming') ?>" class="btn btn-sm btn-primary mr-2">
                <i class="fas fa-file-alt"></i> Stemming
            </a>
            
            <a href="<?php echo base_url('admin/evaluasi/kosongkan_tabel3') ?>" class="btn btn-sm btn-danger mr-2">
        ...
        <table id="example" id="data-tabel" class="table table-bordered mt-2" width="100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center"><?php echo $b->stopw?></td>
